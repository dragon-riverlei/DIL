...
****** level of data completeness for financial statements (balance sheet, cash flow sheet and profit sheet)
       ...
       - level 1: having consecutive annual reports in given range of years.
                  Entry level, data not meeting the criteria won't be taken into account.
       - level 2: having consecutive semi-annual reports in given range of years.
       - level 3: having consecutive quarterly reports in given range of years.
